...
extern "C" {
    void Java_com_pluu_androidcrashsample_ui_JniActivity_initNative(JNIEnv* env, jobject obj, jstring filepath)
    {
        jEnv = env;
    ...
    void Java_com_pluu_androidcrashsample_ui_JniActivity_crashService(JNIEnv* env, jobject obj)
    {
